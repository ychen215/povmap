...
ebphdp_check1 <- function(fixed, pop_data, pop_domains, smp_data, smp_domains, L) {
...
ebphdp_check2 <- function(threshold, 
                       transformation, 
                       interval,
                       MSE, 
                       B,
...
fw_hdp_check2 <- function(pop_domains, pop_domains_vec, smp_domains,
...
fw_hdp_check3 <- function(obs_dom, dist_obs_dom, pop_domains, smp_domains) {
